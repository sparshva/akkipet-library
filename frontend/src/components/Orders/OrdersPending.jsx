    ...
    try {
      await toast.promise(
...

        {
          ...
          success: {
            render({ data }) {
              return data?.data?.message || "Order accepted successfully!";
            },
          },
          ...
          error: {
            render({ data }) {
              return data?.response?.data?.message || "Error accepted order.";
            },
          },
        }
      );
    ...
    try {
      await toast.promise(
        ...
        ),
        {
          ...
          success: {
            render({ data }) {
              return data?.data?.message || "Order rejected successfully!";
            },
          },
          ...
          error: {
            render({ data }) {
              return data?.response?.data?.message || "Error rejecting order.";
            },
          },
        }
      );
