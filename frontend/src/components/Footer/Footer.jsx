...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#ad0000] sticky bottom-0 left-0 right-0 flex py-1 items-center  text-white  ">
      ...
      >
        <div className="flex items-center flex-row text-[16px] cursor-pointer hover:scale-105 transition-transform duration-300 ">
          <LocationOnIcon sx={{ fontSize: "20px", marginRight: "2px" }} />
          <span className="sm:ml-2 text-center sm:text-left">Location </span>
        </div>
      </a>
      <div
        className="flex items-center py-2  justify-center  w-1/2"
        onClick={() => navigate("/")}
      >
        <div className="flex items-center flex-row  text-[16px] cursor-pointer hover:scale-105 transition-transform duration-300">
